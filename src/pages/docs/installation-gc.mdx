...
Optional: This gives you more space for the install
...
If you have thermal paste available apply some to the threat and tip of the thermo sensor.
...
Assemble the pressure sensor, silicone gascet and quick-connect nut.
