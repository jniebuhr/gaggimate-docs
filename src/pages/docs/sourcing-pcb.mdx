...
import Token from '../../components/Tokens.astro';
...
* K-Type M3/M4 Thermocouple - 0.6m (M3 for Silvia, M4 for Gaggia Classic) <Token type="warn" icon>Needs to be an ungrounded thermocouple</Token> [(AliExpress)](https://s.click.aliexpress.com/e/_EwzbL6M)
