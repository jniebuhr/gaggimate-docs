...
title: Flashing
description: Step-by-step guide to flashing firmware onto GaggiMate controllers and displays using the Web Installer. Includes bootloader mode instructions.
...
Once the display has been flashed, the Gaggimate startup screen will be displayed.
